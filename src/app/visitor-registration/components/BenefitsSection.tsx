  ...
  const benefits: Benefit[] = [
    {
      ...
      description:
        'Connectez-vous avec plus de 500 exposants et 5 000 professionnels issus de toute l’Afrique et de la région de l’océan Indien',
    },
    {
      icon: 'PresentationChartLineIcon',
      title: 'Sessions exclusives',
      description:
        'Accédez à des conférences plénières, des panels de haut niveau et des tables rondes sectorielles animés par des experts de l’industrie',
    },
    {
      icon: 'LightBulbIcon',
      title: 'Vitirine de l’innovation',
      description:
        'Découvrez des technologies de pointe, des solutions innovantes et les tendances émergentes qui façonnent le business en Afrique',
    },
    {
      icon: 'HandshakeIcon',
      title: 'Rencontres B2B',
      description:
        'Participez à des rendez-vous préprogrammés avec des partenaires, fournisseurs et investisseurs potentiels en phase avec vos objectifs',
    },
    {
      icon: 'DocumentTextIcon',
      title: 'Intelligence de marché',
      description:
        'Recevez des rapports de marché, des guides d’investissement et des analyses sectorielles pour orienter vos décisions stratégiques',
    },
    {
      icon: 'GlobeAltIcon',
      title: 'Visibilité internationale',
      description:
        'Gagnez en visibilité auprès de la communauté mondiale des affaires et explorez des opportunités de collaboration transfrontalière',
    },
  ];
    ...
    <section className="py-12 lg:py-16 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Rejoignez le plus grand rassemblement d’affaires en Afrique et débloquez des
            opportunités inédites de croissance, de partenariat et d’innovation.
          </p>
        </div>
